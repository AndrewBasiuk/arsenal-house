        ...
        <nav class="nav-container">
            <div class="wrapper nav">
                <ul class="nav__left">
                    ...
                    <li class="nav__item">
                        <a href="#">
                            <div class="nav__icon nav__webcam_icon"></div>
                        </a>
                    </li>
                    <li class="nav__item">
                        <a href="">
        ...
        <div class="building__inner wrapper">
            ...
            <div class="building__next-view">
                <div class="next-view next-view_black">
                    <a href="#">Наступна <span class="next-view__icon next-view__icon_black"></span>сторiнка</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="gallery">
        <div>
            <ul class="vertical-gallery" id="vertical-gallery">
                <li data-thumb="img/main/gallery/thumbnails/1.jpg">
